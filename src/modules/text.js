            ...
            text: async ({ chat_id }) => {
                ...
                if (mainData.length) {
                    ...
                    for (let i = 1; i < mainData.length; i++) {
                        ...
                        sendMessageHelper(chat_id, dataConfirmText(mainInfo, `So'rovlar`, chat_id), (get(user, 'selectedInfoMenu') == "Bajarilmagan so'rovlar" ? btn : undefined))
                    }
                    return dataConfirmText(info, `So'rovlar`)
                }
                return 'Mavjud emas'
